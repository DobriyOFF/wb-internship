const modal = () => {
    ...
    const modalMainWrapper = document.querySelectorAll('.modal__main-wrapper');
    ...
    modalMainWrapper.forEach(item => {
        if (item.lastElementChild.matches('.delivery__form-label')) {
